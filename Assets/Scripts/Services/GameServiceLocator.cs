...
public static class GameServiceLocator
{
    ...
    {
        Persistent,     // Survit aux changements de scène
        SceneScoped,    // Détruit au changement de scène
        Temporary       // Peut être remplacé à tout moment
    }

    /// <summary>
    /// Enregistre un service avec options avancées
    /// </summary>
    ...
    /// <summary>
    /// Récupère un service avec gestion d'erreur robuste
    /// </summary>
...
#if UNITY_EDITOR
    [UnityEditor.MenuItem("Tools/GameServiceLocator/Debug Services")]
    private static void DebugServices()
    {
